...
class IdentityProperties(
    ...
    init {
        require(
            listOf(accessTokenTtl, refreshFamilyTtl, verificationTokenTtl, verificationResendCooldown)
                .all { it.nano == 0 },
    ...
    override fun toString(): String =
        "IdentityProperties(accessTokenTtl=$accessTokenTtl,refreshFamilyTtl=$refreshFamilyTtl," +
            "verificationTokenTtl=$verificationTokenTtl,verificationResendCooldown=$verificationResendCooldown," +
            "issuer=$issuer,audience=$audience,natsUrl=[redacted])"
